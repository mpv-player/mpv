...
#define MSGTR_MPDEMUX_AVIHDR_BrokenODMLfile "AVI: ODML: Rilevato file rovinato (incompleto?). SarÃƒÂ  usato un indice tradizionale.\n"
...
#define MSGTR_LIBVO_TDFXFB_BppOutputIsNotSupported "[VO_TDFXFB] Uscita con %d bpp non supportata (CiÃƒÂ² non sarebbe dovuto accadere).\n"
...
" CiÃƒÂ² potrebbe causare una riproduzione errata o bloccare il programma!\n"\
