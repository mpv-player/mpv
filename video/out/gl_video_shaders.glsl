...
#define USE_CONV 0
    ...
    // that a correct video playback environment should have gamma 2.4, but
    // this includes the typical gamma boost of ~1.2 for dark viewing
    // environments. The figure used here is therefore a pure power curve
    // but without the boost, which is a very close approximation of the true
    // BT.709 function.
