...
{
    // no interest in tablet events, only tablet tool events
}
...
{
    // no interest in tablet pad, only tablet tool events
}
...
static void init_tablet_seat(struct vo_wayland_state *wl, struct vo_wayland_seat *seat)
{
