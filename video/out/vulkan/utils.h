...
#define VK_LOAD_PFN(name) PFN_##name pfn_##name = (PFN_##name) \
    ...
    #define MP_VK_EXTERNAL_SEMAPHORE_EXPORT_EXTENSION_NAME VK_KHR_EXTERNAL_SEMAPHORE_WIN32_EXTENSION_NAME
#else
    #define MP_VK_EXTERNAL_MEMORY_EXPORT_EXTENSION_NAME VK_KHR_EXTERNAL_MEMORY_FD_EXTENSION_NAME
    #define MP_VK_EXTERNAL_SEMAPHORE_EXPORT_EXTENSION_NAME VK_KHR_EXTERNAL_SEMAPHORE_FD_EXTENSION_NAME
#endif
