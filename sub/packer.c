                          ...
                          struct sbr_instanced_raster_pass *pass)
{
    ...
    for (struct sbr_output_instance *instance = instances; instance; instance = instance->next) {
        ...
        inst_b->x = instance->dst_x, inst_b->y = instance->dst_y;
        inst_b->dw = instance->dst_width, inst_b->dh = instance->dst_height;
        inst_b->w = instance->src_width, inst_b->h = instance->src_height;
        inst_b->src_x = image_b->src_x + instance->src_off_x;
        inst_b->src_y = image_b->src_y + instance->src_off_y;
