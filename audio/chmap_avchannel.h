...
// Like mp_chmap_to_av_layout(), but always exact. Emits a native layout when
// the map is in native order, otherwise a custom order layout that preserves
// the original channel order, with NA channels as AV_CHAN_UNUSED.
