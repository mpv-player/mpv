...
#define TEST_LANG_GUESS(filename, expected_lang, expected_start, expected_hi)  \
    ...
    TEST_LANG_GUESS("en.srt", "en", 0, false);
    TEST_LANG_GUESS("en.hi.srt", "en", 0, true);
    TEST_LANG_GUESS("[en-US][hi].srt", "en-US", 0, true);
    TEST_LANG_GUESS("(en-US)(hi).srt", "en-US", 0, true);

    TEST_LANG_GUESS("foo.hi.en.srt", "en", 6, false);
    TEST_LANG_GUESS("foo.en-US)(hi).srt", "", -1, false);
    TEST_LANG_GUESS("foo.en-US)(hi.srt", "", -1, false);
    TEST_LANG_GUESS("foo(en-US](hi).srt", "", -1, false);

    TEST_LANG_GUESS("en-US", "", -1, false);
    TEST_LANG_GUESS("[en-US][hi]", "", -1, false);
    TEST_LANG_GUESS("foo.en-US", "", -1, false);
    TEST_LANG_GUESS(".srt", "", -1, false);
