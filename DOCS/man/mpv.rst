...
n and p
    Go to the next/previous playlist entry.

N and P
    Go to the next/previous sub-playlist (e.g. directory or archive).
...
in the top level of mpv.conf, as enabling it in conditional profiles makes it
